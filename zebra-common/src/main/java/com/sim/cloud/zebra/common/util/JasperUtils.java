...
public class JasperUtils {
	...
	public static Map<String, Integer> getStatusIntegerMap() {
		...
		statusMap.put("DEACTIVATED_NAME", 5); // 已停用
		statusMap.put("RETIRED_NAME", 6); // 已失效
	...
	public static Map<String, String> getStatusStringMap() {
		...
		statusMap.put("STATUS_5", "DEACTIVATED_NAME"); // 已停用
		statusMap.put("STATUS_6", "RETIRED_NAME"); // 已失效
