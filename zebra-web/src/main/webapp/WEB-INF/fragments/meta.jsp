...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/plugins/select2/css/select2.min.css">
   ...
   <!-- Theme style -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/plugins/lte/css/AdminLTE.min.css">
   <!-- Bootstrap 3.3.7 -->
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/plugins/lte/css/skins/_all-skins.min.css">
