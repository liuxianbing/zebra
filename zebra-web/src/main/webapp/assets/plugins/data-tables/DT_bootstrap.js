...
$.extend( true, $.fn.dataTable.defaults, {
	...
	// "sDom": "<'row-fluid'<'span6'f>r>t<'row-fluid'<'span12'i><'span12 center'p><'span12'l>>",
	...
	// "bStateSave":true,
	"bSort":true,
	 "aLengthMenu":[10,25,30,40,50,100],
	"bFilter": false,
	"oLanguage": {
...
$.extend( $.fn.dataTableExt.oPagination, {
	"bootstrap": {
		...
		"fnUpdate": function ( oSettings, fnDraw ) {
			//全站留存和客服留存 点击分页按钮时触发列显示隐藏
			if($.isFunction(window.displayAeAu)){
				displayAeAu()
			}
			var iListLength = 5;
